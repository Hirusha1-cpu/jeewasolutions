...
public class EmployeeController {
    ...
    public String update(@RequestBody Employee employee){
         ...
         //e update eka karapu employee , kalinm e record eka aithi employee ta samanada balanwa
         ...
         try {
            ...
            dao.save(employee);
            //user kenekge working status eka arenna eya resign or deletede status ekakata maru unoth 
            //delete button eken, delete option eken wgema status eka update karana ekenut apita userge status 
