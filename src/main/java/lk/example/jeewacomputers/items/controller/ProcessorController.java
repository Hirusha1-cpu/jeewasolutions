...
public class ProcessorController {
    ...
    @GetMapping(value = "/processor/getlist", produces = "application/json")
    ...
    public ModelAndView employeeUI() {
        ...
        viewEmp.addObject("modulename", "Processor");
        viewEmp.addObject("title", "Processor");
        viewEmp.setViewName("forms/proceccor_form.html");
        return viewEmp;
    }   
}
