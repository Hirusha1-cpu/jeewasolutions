...
public class PowerSupplyController {
       @Autowired
    private PowerSupplyDao dao;

    @GetMapping(value = "/powersupply/getlist", produces = "application/json")
    ...
    public ModelAndView employeeUI() {
        ...
        viewEmp.addObject("modulename", "PowerSupply");
        viewEmp.addObject("title", "PowerSupply");
        viewEmp.setViewName("forms/power_supply_form.html");
        return viewEmp;
    } 
}
