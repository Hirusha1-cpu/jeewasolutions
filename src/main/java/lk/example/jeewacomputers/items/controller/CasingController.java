...
public class CasingController {
       @Autowired
    private CasingDao dao;

    @GetMapping(value = "/casing/getlist", produces = "application/json")
    ...
    public ModelAndView employeeUI() {
        ...
        viewEmp.addObject("modulename", "Casing");
        viewEmp.addObject("title", "Casing");
        viewEmp.setViewName("forms/casing_form.html");
        return viewEmp;
    }
